	...
	public void Login_EWA() throws Exception {
	 ...
	 @Test(priority = 02)
		public void Verify_to_Create_Template() throws InterruptedException, IOException {
			...
			Thread.sleep(4000);
			movingDoublecli(TemplatePage.Template_Test_Cabinet(driver), TemplatePage.Template_Test_Cabinet(driver));
			Thread.sleep(5000);
			//movingDoublecli(TemplatePage.Template_Test_Drawer(driver), TemplatePage.Template_Test_Drawer(driver));
			jsclick(TemplatePage.Template_Test_Drawer(driver));
			jsclick(TemplatePage.Template_Test_Drawer(driver));
			Thread.sleep(4000);
	        movingDoublecli(TemplatePage.Template_Folder(driver), TemplatePage.Template_Folder(driver));
			...
			Thread.sleep(4000);
			TemplatePage.Template_Created_OK_button(driver).click();
			Reporter.log("New Template created successfully!!", true);
			Thread.sleep(3000);
			TemplatePage.Moveto_Templates_Option(driver);
			Thread.sleep(4000);
			TemplatePage.Select_Created_Template(driver).click();
			Thread.sleep(4000);
			TemplatePage.Created_button(driver).click();
			Thread.sleep(4000);
