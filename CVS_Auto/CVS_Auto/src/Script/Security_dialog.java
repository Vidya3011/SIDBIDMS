...
public class Security_dialog extends Generic.BaseClass {
   ...
   @Test(priority=1)
	...
	public void Open_Security_Dialog_And_Verify_Title() throws InterruptedException {
		...
		Thread.sleep(3000);
		jsclick(Pom.Security.security_Room(driver));
		WebDriverWait wait=new WebDriverWait(driver,30);
		wait.until(ExpectedConditions.elementToBeClickable(Pom.Security.Select_Cabinet(driver)));
	...
	public void Verify_Add_User_And_Give_Permissions() throws InterruptedException {
		...
		jsclick(Pom.Security.OK_Button_UserDialog(driver));
		Thread.sleep(4000);
