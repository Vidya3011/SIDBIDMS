...
public class INWARD_INTERNAL_WORKFLOW extends Generic.BaseClass {
	...
	// Create Inward Internal document and send to WF
	...
	public void TC_01_Create_INWARD_Document_and_sendTo_Inward_Workflow() throws Exception {
		...
		pojo.Create_INWARD_Document_and_sendTo_Inward_Internal_Workflow();
	...
	public void TC_12_Create_INWARD_Document_and_sendTo_Inward_Workflow_Approve_and_PSR() throws Exception {
		...
		Create_DOC pojo = new Create_DOC();
		pojo.Create_INWARD_Internal_Document_and_sendTo_Inward_Workflow_Approve_and_PSR();
	...
	// Create Inward Internal document and send to WF for Intimate
	...
	public void TC_31_Create_INWARD_Internal_Document() throws Exception {
		Create_DOC pojo = new Create_DOC();
		pojo.Create_INWARD_Internal_Document_and_sendTo_Inward_Workflow_For_Intimation();
