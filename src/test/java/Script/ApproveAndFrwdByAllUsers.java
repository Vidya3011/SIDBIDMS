...
public class ApproveAndFrwdByAllUsers extends BaseClass{
	@BeforeClass
	...
	public void Tc02_CreateOfficeNoteDynamicWF() throws Exception {
		...
		pojo.DynamicWorkFlow_With_All_Users();
	...
	public void Tc07_User1_ApproveAnd_PSR() throws Exception {
		Reporter.log("Scenario 7:Task User-1 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
	...
	public void Tc09_User_1_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 9 : Add a Next Task User");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_8();
	...
	@Test(priority = 10)
	public void Tc10_User_1_EnterCommentAndApprovedForwardR() throws Exception {
		Reporter.log("Scenario 10:Enter Comments  into the 'Approve and Forward' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
	...
	@Test(priority =13)
	public void Tc13_User2_ApproveAnd_Forward() throws Exception {
		Reporter.log("Scenario 13:Task User-2 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc15_User_2_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 15 : Add a Next Task User");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_7();
		Reporter.log("Next task user added successfully...");
		Thread.sleep(4000);
	...
	@Test(priority = 16)
	public void Tc16_User_2_EnterCommentAndApprovedForward() throws Exception {
		Reporter.log("Scenario 16:Enter Comments  into the 'Approve and Forward' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.AcceptAndForWardCommentBox();
		Thread.sleep(4000);
		Reporter.log(
	...
	@Test(priority =19)
	public void Tc19_User3_ApproveAnd_Forward() throws Exception {
		Reporter.log("Scenario 19:Task User-3 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc21_User__3Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 21 :Add a next task user");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_6();//ajit
		Reporter.log("Next task added Successfully...");
		Thread.sleep(4000);
	}
	
	@Test(priority = 22)
	public void Tc22_User_3_EnterCommentAndApprovedForward() throws Exception {
		Reporter.log("Scenario 22:Enter Comments  into the 'Approve and PSR' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.AcceptAndForWardCommentBox();
		Thread.sleep(4000);
		Reporter.log(
	...
	@Test(priority =25)
	public void Tc25_User5_ApproveAnd_Forward() throws Exception {
		Reporter.log("Scenario 25:Task User-4 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc27_User__4_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 27 : Add a next task user");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_10();
		Reporter.log("Next task user Successfully...");
		Thread.sleep(4000);
	}
	
	@Test(priority = 28)
	public void Tc28_User_4_EnterCommentAndApprovedForward() throws Exception {
	...
	@Test(priority = 31)
	public void Tc31_User5_ApproveAndEnd_Forward() throws Exception {
		Reporter.log("Scenario 31:Task User-5 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc33_User_5_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 29: Add a Next Task User");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_6();
		Reporter.log("Next task user added successfully...");
		Thread.sleep(4000);
	...
	@Test(priority = 34)
	public void Tc34_User_5_EnterCommentAndEndForward() throws Exception {
		Reporter.log("Scenario 34:Enter Comments  into the 'Approve and Forward' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.AcceptAndForWardCommentBox();
		Thread.sleep(4000);
		Reporter.log(
	...
	@Test(priority = 37)
	public void Tc37_User6_ApproveAnd_Forward() throws Exception {
		Reporter.log("Scenario 37:Task User-6 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc39_User_6_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 39 :Add a Next Task User");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_7();
		Reporter.log("Next task user added successfully...");
		Thread.sleep(4000);
	...
	@Test(priority = 40)
	public void Tc40_User_6_EnterCommentAndApprovedForward() throws Exception {
	...
	@Test(priority = 43)
	public void Tc43_User7_ApproveAnd_Forward() throws Exception {
		Reporter.log("Scenario 43:Task User-7 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc45_User_7_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 45 : Add a next task user");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_8();
		Reporter.log("Next task user added successfully...");
		Thread.sleep(4000);
	...
	@Test(priority = 46)
	public void Tc46_User_7_EnterCommentAndApprovedForward() throws Exception {
		Reporter.log("Scenario 46:Enter Comments  into the 'Approve and Forward' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.AcceptAndForWardCommentBox();
		Thread.sleep(4000);
		Reporter.log(
	...
	@Test(priority = 49)
	public void Tc49_User8_ApproveAnd_Forward() throws Exception {
		Reporter.log("Scenario 49:Task User-8 'Approve and Forward'");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc51_User_8_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 51 :Add a next task user");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_9();
		Reporter.log("Next Task User  added Successfully...");
		Thread.sleep(4000);
	...
	@Test(priority = 52)
	public void Tc52_User_8_EnterCommentAndApprovedForwardR() throws Exception {
		Reporter.log("Scenario 52:Enter Comments  into the 'Approve and Forward' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.AcceptAndForWardCommentBox();
		Thread.sleep(4000);
		Reporter.log(
	...
	public void Tc54_Task_User9_Login() throws Exception {
		Reporter.log("Scenario 44:Login as Task User-9");
		loginArora();
	}

	@Test(priority = 55)
	public void Tc55_User9_ApproveAnd_Forward() throws Exception {
		Reporter.log("Scenario 55:Task User-9 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc57_User_9_Add_One_More_Task_User() throws Exception {
		Reporter.log("Scenario 57 : Add a next task user");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.selectUser_10();
		Reporter.log("Next Task User added Successfully...");
		Thread.sleep(4000);
	...
	@Test(priority = 58)
	public void Tc58_User_9_EnterCommentAndApprovedForward() throws Exception {
		Reporter.log("Scenario 58:Enter Comments  into the 'Approve and Forward' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.AcceptAndForWardCommentBox();
		Thread.sleep(4000);
		Reporter.log(
	...
	public void Tc61_User10_ApproveAnd_PSR() throws Exception {
		Reporter.log("Scenario 61:Task User-10 'Approve and Forward' ");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.ApproveAndForward();
	}
	...
	public void Tc63_User_10_EnterCommentAndApprovedPSR() throws Exception {
		Reporter.log("Scenario 63:Enter Comments  into the 'Approve and Forward' commentbox");
		WorkflowPOM pojo = new WorkflowPOM();
		pojo.AcceptAndForWardCommentBox();
		Thread.sleep(4000);
		Reporter.log(
				"Document Approved by All Users Successfully..");
	}
